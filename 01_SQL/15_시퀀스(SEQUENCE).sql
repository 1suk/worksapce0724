...
/*
    ...
    [START WITH 시작 숫자] -> 처음 발생시킬 시작값을 지정(기본값 1)
...
/*
    2. 시퀀스 사용
    시퀀스명.NEXTLEVEL : 다음 숫자 발생(INCREMENT 만큼 증가)
...
SELECT SEQ_EMPNO.CURRVAL FROM DUAL; --에러발생, 아래꺼 실행 후 300
SELECT SEQ_EMPNO.NEXTVAL FROM DUAL; --300
SELECT SEQ_EMPNO.NEXTVAL FROM DUAL; --305
SELECT SEQ_EMPNO.NEXTVAL FROM DUAL; --310

SELECT SEQ_EMPNO.NEXTVAL FROM DUAL; --MAX VALUE 310 -> ERROR 발생
/*
    3. 시퀀스 수정
...
VALUES(SEQ_EMPNO.NEXTVAL, '최지구','701011-1234567', 'J7');

INSERT INTO EMPLOYEE(EMP_ID, EMP_NAME, EMP_NO, JOB_CODE)
VALUES(SEQ_EMPNO.NEXTVAL, '최지열','701011-1234567', 'J6');
