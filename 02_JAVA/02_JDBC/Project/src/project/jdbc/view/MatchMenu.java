...
public class MatchMenu {
	...
	public void MainMenu() {
		while(true){
	        ...
	        System.out.println("1. 경기 일정 추가");
	        System.out.println("2. 전체 경기 일정 조회");
	        System.out.println("3. 경기 일정 수정");
	        System.out.println("4. 경기 일정 삭제");
	        System.out.println("5. 경기 결과 입력");
	        System.out.println("6. 전체 팀 순위 조회");
		...
		public void insertMatch() {
			...
			System.out.println("경기 날짜를 입력하세요 : ");
		...
		public void displayList(List<Match> list) {
			System.out.println("===== 전체 경기 일정 조회 =====");
		...
		public void deleteMatch() {
			...
			System.out.println("===== 경기 일정 삭제 =====");
			System.out.println("경기 번호를 입력하세요 : ");
		...
		public void updateResult() {
			...
			System.out.println("경기 번호를 선택해주세요 :");
