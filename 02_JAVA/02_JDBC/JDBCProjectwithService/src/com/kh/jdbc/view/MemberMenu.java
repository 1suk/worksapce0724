...
public class MemberMenu {
    ...
    public void deletemembers() {
    	System.out.println("삭제할 회원들 아이디 입력 : ");
    	String inputIds = sc.next().trim();
    	sc.nextLine();
    	List<String> userIds = new ArrayList<>();
    	
    	String[] arr = inputIds.split(",");
    	
    	for(String id : arr) {
    		userIds.add(id.trim());
    	}
    	mc.deleteMembers(userIds);
    }
