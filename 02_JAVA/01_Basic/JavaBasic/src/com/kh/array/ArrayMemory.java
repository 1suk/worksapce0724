...
public class ArrayMemory {
	...
	public static void main(String[] args) {
		...
		//Heap이라는 메모리 공간은 절대 빈공간을 허용하지 않기 때문
		//-> 메모리가 할당될 때 JSM이 기본값으로 모두 초기화
		...
		// . : 접근연산자
		//iArr.hashCode();
		//NullPointerException -> 참조변수가 가지고 잇는 주소값이 없다.
		 ...
		 * => 자바에서의 "자동메모리 관리" 특징 => 개발자는 코드에 집중할 수 있음.
		 * */
		...
		//false -> 각 참조변수는 ==을 통해서 비교시 주소값 비교를 하기 때문에
