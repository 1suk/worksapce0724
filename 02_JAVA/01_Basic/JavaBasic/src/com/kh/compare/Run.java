 ...
 * */
	public static void main(String[] args) {
		...
		System.out.println("Comperator 이름 오름차순 정렬 후");
		System.out.println(list);
		
		Collections.sort(list, new ScoreDescComperator());
		System.out.println("Comperator 점수 오름차순 정렬 후");
		System.out.println(list);
		
		Collections.sort(list, new ScoreDescAndNameAscComparator());
		System.out.println("Comperator 점수 내림차순 & 이름 오름차순 정렬 후");
		System.out.println(list);
	}
