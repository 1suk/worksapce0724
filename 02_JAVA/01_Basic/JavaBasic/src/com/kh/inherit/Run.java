...
public class Run {
	 ...
	 * -> 객체 생성시 부모부분 -> 자시부분 순으로 메모리에 구성되며, 자식객체 내부에 부모객체가 존재하는 것
	 * 
	 * 장점
	 ...
	 * 
	 * super와 생성자 : 
	 * - 자식생성자 첫줄에는 super(...)키워들ㄹ 통한 부모생성자 호출 가능
	 * - 생략시 부모의 기본생성자가 자동호출
	 * 
	 * Object의 후손 :
	...
	public static void main(String[] args) {
		...
		BusinessMan m2 = new BusinessMan("장일석","kh","학생");
		m2.tellYourInfo();
		m2.tellYourName();
...
//		
//		TV t1 = new TV();
//		TV t2 = new TV("t-100", 10000, "LG", 65);
//		
