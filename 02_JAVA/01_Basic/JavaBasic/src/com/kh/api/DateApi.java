...
public class DateApi {
	public void method() {
		...
		//Java8에 도입된 클래스
		//날짜와 시간을 함께 표현하는 객체
		//시차/타입존을 고려하지 않음 -> 순수하게 지금 내 날자와 시간정보를 다룸
		
		//1. 현재 날짜와 시간
		LocalDateTime now = LocalDateTime.now();
		System.out.println("현제 시간 : " + now);
		
		//2. 특정 날짜와 시간 생성
		LocalDateTime date3 = LocalDateTime.of(2026, 3, 3, 0, 0, 0, 0);
		System.out.println("특정 날짜와 시간 :" + date3); //date3에서 10일 뒤 
