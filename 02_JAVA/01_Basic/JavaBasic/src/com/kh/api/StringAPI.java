...
public class StringAPI {
	public void method01() {
		...
		//String클래스에 toString 메서드는 이미 오버라이딩 되어있음
		//그래서 참조변수 출력시 Object의 toString 형식(타입@주소값16진수)이 아니라 String의 저장된 문자열이 반환됨
		
		System.out.print(str1 == str2);
		System.out.println();
		//String 객체의 주소값을 비교하기 때문에 false가 나옴, 메모리 공간을 new로 각각 만들어줌
		System.out.println(str1.equals(str2));
		//String 클래스에서 equals 메서드도 이미 오버라이딩 되어있음(주소값 비교가 아니라 문자열 값을 비교하도록)
		System.out.println(arr1.equals(arr2));
		
		//String클래스에서 hashCode메소드도 이미 오버라이딩 되어있음(주소값이 아닌 문자열을 가지고 해시값을 만들도록)
		System.out.println(str1.hashCode());
		System.out.println(str2.hashCode());
		
		//System.identityHashCode(참조변수)
		//해당 참조변수의 메모리값을 기반으로 해시값을 반환
		...
		str3 = "bye";
		System.out.println(System.identityHashCode(str3));
		//String 리터럴의 특성상 참조변수에 값을 변경하는 순간 기존의 문자열 메로리에 값을 변경하는게 아니라
		//상수이기 때문에 새로운 값을 String풀에 만들고 참조하도록 되어있음
	...
	public void method02() {
		...
		//믄지열.concat(String str) : String
		//문자열과 전달된 또다른 문자열을 하나로 합쳐서 새로운 문자열은 리턴
